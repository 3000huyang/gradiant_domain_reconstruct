...
%% Update
% ver.0 Code is released. (2016/07/06) 
% ver.1 Introduce line search parameter beta. (2016/07/06) 
...
beta = 0.999; % line search parameter, range:(0, 1), (2016/07/06)  
...
if ~lmd
    if numel(umin)==1
        ...
        for i = 1:itr
            ...
            % update eta
            eta = beta*eta;  % line search parameter is updated (2016/07/06) 
        end
    else
